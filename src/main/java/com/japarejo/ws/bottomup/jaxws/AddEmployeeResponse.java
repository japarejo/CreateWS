...
@XmlRootElement(name = "addEmployeeResponse", namespace = "http://bottomup.ws.japarejo.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addEmployeeResponse", namespace = "http://bottomup.ws.japarejo.com/")
